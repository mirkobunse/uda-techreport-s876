...
NAME="uda" # default container name
RESOURCES="-c 4 -m 128g" # default resources allocated by each container
MNT_DATA="/rdata/s01f_c3_004/uda" # mount point for data files
PORT=5555
...
echo "| Usage: $0 [-r <resources>] [-n <name>] [-p <port>] [args...]"
...
case "$1" in
    ...
    -n|--name) # configure the container name
        ...
        shift 2
        ;;
    -p|--port) # configure the container name
        PORT="$2"
        shift 2
        ;;
    *) break ;;
